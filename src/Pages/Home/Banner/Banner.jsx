    ...
    return (
      ...
      <div className="md:absolute top-0 left-0 w-full h-full">
        ...
        <div className="flex absolute z-10 inset-0 flex-col items-center justify-center ">
          ...
          <p className="text-sm flex text-center lg:text-xl w-auto lg:w-[700px] mx-auto text-white md:p-6 lg:p-0 mt-4 font-medium">
          ...
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold text-xl py-2 mt-6 px-4 rounded-full shadow-md transition duration-300 ease-in-out">
      Menu Page
    </button>
