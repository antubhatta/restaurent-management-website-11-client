        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p>Indulge in our chefs finest creations made from the freshest ingredients.</p>
            </div>
            <div className="text-center">
              ...
              <p>Our team is dedicated to providing a delightful dining experience for every guest.</p>
            </div>
            <div className="text-center">
              ...
              <p>We prioritize our customers needs, ensuring satisfaction and comfort.</p>
            </div>
          </div>
        </div>
      </div>
