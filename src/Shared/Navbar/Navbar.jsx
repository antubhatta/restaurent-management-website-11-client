...
//    const {user,logOut}=useContext(AuthContext)
    ...
    const navLinks = <>
        ...
        <li><NavLink to="/food">All Food</NavLink></li>
        ...
        <div className="bg-[#2C3E50] py-4 z-50">
          ...
          <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu  menu-sm text-sm md:text-lg dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box z-50 text-white w-52">
                        {navLinks}
                    </ul>
                </div>
              <div className="flex gap-2 items-center">
              <img src={logo} alt="" />
              <Link to="/" className=" normal-case text-lg md:text-xl lg:text-2xl font-bold"><p className="text-indigo-400" >EatsHub</p></Link>
